...
comb_pl <- cowplot::plot_grid(plotlist = pl_list, nrow = 4, ncol = 1, align = "vh", axis = "l", rel_heights = c(1.1, 2, 2, 1.1))
comb_pl <- cowplot::ggdraw(comb_pl) +
  cowplot::draw_label(x = 0.40, y = 0.735, label = "Type II pneumocytes", size = font_size_small) +
  cowplot::draw_label(x = 0.365, y = 0.71, label = "Other cells", size = font_size_small) +
  cowplot::draw_line(x = c(0.4, 0.46), y = c(0.728, 0.68), size = 0.2) +
  cowplot::draw_line(x = c(0.365, 0.38), y = c(0.703, 0.68), size = 0.2)
