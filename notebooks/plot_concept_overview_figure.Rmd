...
plot_assemble(
  ...
  annotate_text("(A) Confounding between size factors and PCA embedding of droplets encapsulating identical RNA", 
  ...
  annotate_text(paste0("(C) Distribution of values for a single gene (Sftpc) with a bimodal expression pattern in lung epithelium"), 
