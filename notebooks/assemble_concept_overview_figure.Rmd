...
plot_assemble(
  ...
  annotate_text("(A) Confounding between sequencing depth and PCA embedding of transformed data from droplets encapsulating identical RNA", 
  ...
  annotate_text(paste0("(C) Distribution of transformed values for a single gene (Sftpc) with a bimodal expression pattern in lung epithelium"), 
