...
make_main_plot_panel <- function(data, add_group_label = FALSE){
  ggplot(data, aes(x= knn_recovery, y = transformation, color = family)) +
    ...
    scale_x_continuous(limits = c(0.2, 1.8), breaks = c(0.5, 1, 1.5)) +
...
plot_assemble(list(plot = perf_plot,          x = 0, y = 0,   width = 90, height = 60),
              ...
              annotate_text("Dino", fontsize = font_size_small, x = 77, y = 75),
              annotate_text("...", fontsize = font_size_small, x = 80, y = 80, angle = 90),
              annotate_text("$\\log(x/s+1)$\n\\;$\\rightarrow$HVG", fontsize = font_size_small, x = 77, y = 88),
