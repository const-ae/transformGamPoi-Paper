...
res_alt_knn %>%
  ...
  write_tsv("../output/suppl_alt_k_benchmark_source_data.tsv")
```
...
plot_assemble(
  list(plot = con_suppl_pl, x = 0, y = 0, width = 180, height = 140),
  list(plot = sim_suppl_pl, x = 0, y = 140, width = 180, height = 80),
  list(plot = dow_suppl_pl, x = 0, y = 220, width = 180, height = 80),
  width = 180, height = 300, units = "mm", show_grid_lines = FALSE,
...
res_full_bench %>%
  ...
  write_tsv("../output/suppl-raw_benchmark_results_source_data.tsv")
```
