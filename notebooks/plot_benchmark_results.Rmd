...
```{r}
plot_assemble(annotate_text("(A) Consistency", x = 2, y =1, vjust = 1, fontsize = font_size, fontface = "bold"),
              annotate_text("(B) Simulation", x = 62, y = 1, vjust = 1, fontsize = font_size, fontface = "bold"),
              annotate_text("(C) Downsampling", x = 122, y = 1, vjust = 1, fontsize = font_size, fontface = "bold"),
