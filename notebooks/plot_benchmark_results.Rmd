...
consistency_pl <- res_main %>%
  ...
  labs(x = "Relative $k$-NN Overlap", 
       title = "(A) Consistency", subtitle = "10X gene subset A vs. gene subset B") +
  NULL
...
simulation_pl <- res_main %>%
  ...
  labs(x = "Relative $k$-NN Overlap", 
       title = "(B) Simulation", subtitle = "Ground truth vs. simulated counts") +
  NULL
...
downsampling_pl <- res_main %>%
  ...
  make_main_plot_panel(add_group_label = FALSE) +
  labs(x = "Relative $k$-NN Overlap", 
       title = "(C) Downsampling", subtitle = "Original vs. downsampled Smart-seq3 data") +
  NULL
...
```{r}
plot_assemble(list(plot = consistency_pl,     x = 0,  y = 0,    width = 60, height = 75),
              list(plot = simulation_pl,      x = 60, y = 0,    width = 60, height = 75),
              list(plot = downsampling_pl,    x = 120,  y = 0,   width = 60, height = 75),
              annotate_text("(D) $k$-NN overlap depends on \\#PCA-dimensions", x = 2, y = 78, fontsize = font_size, fontface = "bold"),
              list(plot = pca_pl_random_walk, x = 0,   y = 78,  width = 44, height = 23),
              list(plot = pca_pl_scDesign2,   x = 45,  y = 78,  width = 44, height = 23),
              list(plot = pca_pl_siRNA_kd,    x = 90,  y = 78,  width = 44, height = 23),
              list(plot = pca_pl_10X,         x = 135, y = 78,  width = 44, height = 23),
              width = 180, height = 101, units = "mm", show_grid_lines = FALSE,
...
rel_scaling_factor_lin <- median(filter(res, transformation == "logp1", dataset == sel_dataset, pca_dim == 10)$cputime_sec)
...
perf_plot <- res %>%
  ...
  ggplot(aes(x = transformation, y = cputime_sec)) +
    ...
    labs(title = "(A) Computational expense for transf. and $k$-NN calculation", y = "")
...
plot_assemble(list(plot = perf_plot,          x = 0, y = 0,   width = 90, height = 60),
              ...
              annotate_text("Sanity MAP", fontsize = font_size_small, x = 77, y = 72),
