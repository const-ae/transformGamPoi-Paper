...
```{r}
system.time(
  assay(subset_sce, "pearson") <- transformGamPoi::transformGamPoi(as.matrix(assay(subset_sce, "counts")), 
...
```{r}
system.time(
  assay(subset_sce, "rand_quantile") <- transformGamPoi::transformGamPoi(as.matrix(assay(subset_sce, "counts")), 
                                                             size_factors = sf, overdispersion = alpha,
