...
```{r}
cairo_pdf("../output/randomized_quantile_figure/gp_hist.pdf", width = 3, height = 3)
...
cdf <- ecdf(y)
cairo_pdf("../output/randomized_quantile_figure/gp_cdf.pdf", width = 3, height = 3)
...
# cairo_pdf("../output/randomized_quantile_figure/normal_dens.pdf", width = 3, height = 3)
# plot(y2, type = "l")
# dev.off()

cairo_pdf("../output/randomized_quantile_figure/normal_cdf.pdf", width = 3, height = 3)
...
cairo_pdf("../output/randomized_quantile_figure/res_hist.pdf", width = 3, height = 3)
...
```{r}
cairo_pdf("../output/randomized_quantile_figure/bimod_gp_hist.pdf", width = 3, height = 3)
...
cairo_pdf("../output/randomized_quantile_figure/bimod_gp_cdf.pdf", width = 3, height = 3)
...
cairo_pdf("../output/randomized_quantile_figure/bimod_res_hist.pdf", width = 3, height = 3)
